...
// -------ON HOVER OF OUR OFFICES--------*
$(".citySelection li").on('hover mouseover mousein', function () {
	if (!$(this).hasClass("activeCity")) {
			$('.activeCity').removeClass('activeCity');
			$(".activeContent").fadeOut(1);
			$('.activeContent').removeClass('activeContent');

			var newContent = $('#' + $(this).data('target'));
			$(this).addClass('activeCity');
			newContent.fadeIn(700);
			newContent.addClass('activeContent');
	}
});



// *-------------MY MANIPULATION ENDS HERE------*
